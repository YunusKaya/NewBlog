...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link " @if(Request::segment(2) =='kategoriler') style="color:white" @endif href="{{route('admin.category.index')}}">
                <i class="fa fa-list" aria-hidden="true"  @if(Request::segment(2) =='kategoriler') style="color:white" @endif></i>
